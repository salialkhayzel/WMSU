...
class HeaderAdmin extends Component
{
    ...
    public function mount(Request $request){
        ...
        if(isset($user_details['user_id'])){
            ...
            ->select('u.user_status_id','us.user_status_details', 'ur.user_role_id', 'ur.user_role_details','u.user_profile_picture','user_firstname','user_lastname','user_middlename')
